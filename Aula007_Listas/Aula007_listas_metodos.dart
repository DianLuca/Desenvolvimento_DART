void main() {
  ...
  // addAll: adiciona vários elementos a final da lista
  ...
  List<double> listaDoubles = [1.1, 2.2, 3.3];
  print('Lista original: $listaDoubles');
  listaDoubles.removeAt(1);
  print('Lista nova: $listaDoubles');
  print('-' * 70);
