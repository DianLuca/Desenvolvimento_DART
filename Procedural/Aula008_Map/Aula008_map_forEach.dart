void main() {
  /* 
    ...
    - O Map principal tem como o NOME da atriz (tipo String).
    - O valor associado a cada chave é outro Map (submap).
  ...
  */
  atrizes.forEach((nome, dados) {
    print('$nome - Nascimento: ${dados['nascimento']}, Altura: ${dados['altura']}m');
  });

  // Outro separados para finalizar a exibição
  print('-' * 70);
}